          ...
          <div >
              <Grid>
                  <Cell col={4}>
                      ...
                      <h2 style={{paddingTop:'2em', color:'grey', textAlign:'center'}}>Angel Cochachez</h2>
                    ...
                    <Skills 
                        ...
                        progress={100}
                    />
                    <ProgressBar skill="Phyton" indeterminate />
                    <Skills 
                        skill="React"
                        progress={100}
                    />
                    <ProgressBar skill="React Native" progress={80} buffer={20} />
                    <Skills 
                        skill="NodeJS"
                        progress={100}
                    />
